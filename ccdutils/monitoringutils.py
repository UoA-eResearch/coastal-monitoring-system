...
def gen_aoi_mask(cls_img, folder):
    ...
    imageutils.gen_valid_mask(cls_img, aoi_msk_img, 'KEA', 0.0)
...
def download_historical_imagery(gdf, down_dir):
    ...
    cls_img_path = return_initial_cls_img(gdf, cell_dir_path) # return initial classification image 
    aoi_file_path = gen_aoi_mask(cls_img_path, cell_dir_path) # return aoi mask 
